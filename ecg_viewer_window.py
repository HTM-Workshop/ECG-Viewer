...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.capture_rate_box = QtWidgets.QSpinBox(self.gridFrame_21)
        self.capture_rate_box.setObjectName("capture_rate_box")
        self.verticalLayout.addWidget(self.capture_rate_box)
        ...
        self.label_12 = QtWidgets.QLabel(self.gridFrame_21)
        self.label_12.setObjectName("label_12")
        self.verticalLayout.addWidget(self.label_12)
        self.height_box = QtWidgets.QSpinBox(self.gridFrame_21)
        self.height_box.setObjectName("height_box")
        self.verticalLayout.addWidget(self.height_box)
        ...
        self.window_length_box.setProperty("value", 7)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_7.setText(_translate("MainWindow", "Capture Rate (ms)"))
        self.label_8.setText(_translate("MainWindow", "PD - Holdoff"))
        self.label_9.setText(_translate("MainWindow", "PD - Prominence"))
        self.label_12.setText(_translate("MainWindow", "PD - Min Height"))
